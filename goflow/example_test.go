...
func TestDecision1(t *testing.T) {
	...
	bytes := LoadXML("/Users/deer_mac/Desktop/VERYIMPORTANT/Go/项目/工作流/goflow/res/decision1.xml")
	engine := NewEngineByConfig("conf/app.conf")
	processId := engine.Deploy(bytes, "")
...
func TestDecision2(t *testing.T) {
	...
	bytes := LoadXML("/Users/deer_mac/Desktop/VERYIMPORTANT/Go/项目/工作流/goflow/res/decision2.xml")
	engine := NewEngineByConfig("conf/app.conf")
	processId := engine.Deploy(bytes, "")
